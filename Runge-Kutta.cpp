...
// Runge-Kutta.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CRungeKuttaApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CRungeKuttaApp

CRungeKuttaApp::CRungeKuttaApp()
{
...
// Единственный объект CRungeKuttaApp

CRungeKuttaApp theApp;


// инициализация CRungeKuttaApp

BOOL CRungeKuttaApp::InitInstance()
{
